...
def analyze_candle(candle):
    ...
    return {
        ...
        "upper_wick": round_price(
            upper_wick
        ),

        "lower_wick": round_price(
            lower_wick
        ),
...
def candle_signal(candle):
    ...
    if direction == "BULLISH":
        ...
        if (
            ...
            reasons.append(
                "Bullish close near candle high"
            )
